    ...
    <div className="App">
      ...
      <div className="todo-wrapper">
        ...
        <div className="btn-area">
          <button
            className={`isCompleteScreen ${isCompleteScreen === false ? 'active' : ''}`} onClick={() => setIsCompleteScreen(false)}>Todo</button>
          ...
          {isCompleteScreen === false &&  allTodos.map((item, index) => (
            <div className="todo-list-item" key={index}>
              ...
              <div>
                ...
                <IoIosCheckmark className="check-icon"  onClick={()=> handlecomplete(index) } title="Complete?" />
              </div>
            </div>
          ))}
